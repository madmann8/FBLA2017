...
//  YardSale
//
//  Created by Luke Mann on 2/17/17.
...
class MainBrowseViewController: UIViewController {
    ...
    func tableView(tableView: UITableView, cellForRowAtIndexPath indexPath: NSIndexPath) -> UITableViewCell {
        let cell = tableView.dequeueReusableCellWithIdentifier("FoldingCell", forIndexPath: indexPath as IndexPath)
...
extension MainBrowseViewController: UIViewControllerTransitioningDelegate {
